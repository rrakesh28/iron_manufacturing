        ...
        <div className="flex bg-gray-100 min-h-screen">
            ...
            <aside className="flex flex-col">
                <Link href="#" className="inline-flex items-center justify-center h-20 w-full bg-blue-600 hover:bg-blue-500 focus:bg-blue-500">
                    ...
                    <span className="text-white text-4xl ml-2">HMT</span>
                </Link>
                <div className="flex-grow flex flex-col justify-between text-gray-500 bg-gray-800">
                    <nav className="flex flex-col mx-4 my-6 space-y-4">
                        <Link href={route('inventory.index')} className="inline-flex items-center py-3 hover:text-gray-400 hover:bg-gray-700 focus:text-gray-400 focus:bg-gray-700 rounded-lg px-2">
                    ...
                    <div className="flex justify-end">
                        <Link href={route('settings')} className="inline-flex p-3 hover:text-gray-400 justify-center border-gray-700 h-15 w-full border-t hover:bg-gray-700 focus:text-gray-400 focus:bg-gray-700 px-2">
                            <svg aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="h-6 w-6">
                ...
                <header className="flex items-center h-20 px-6 sm:px-10 bg-white">
                    ...
                    <div className="flex flex-shrink-0 items-center ml-auto">
                        ...
                        <div className="border-l pl-3 ml-3 space-x-1">
                            ...
                            <Link href={route('logout')} method="post" className="relative p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-600 focus:bg-gray-100 focus:text-gray-600 rounded-full">
