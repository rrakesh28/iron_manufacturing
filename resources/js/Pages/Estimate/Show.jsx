...
function Show({estimate}) {
    ...
    const addCrimpingCharges = (e) => {
        e.preventDefault();
        axios.post(route('estimate.addCrimpingCharges', {
            estimate: estimate,
    ...
    const addLoadingCharges = (e) => {
        e.preventDefault();
        axios.post(route('estimate.addLoadingCharges', {
            estimate: estimate,
            ...
            <div className='mt-10 px-[2rem]'>
                ...
                <div className="flex gap-2 justify-center">
                    <button onClick={
                        ...
                        className='block mt-2 bg-blue-600 text-white px-6 py-2 rounded-lg'>Crimping Charges</button>
                    <button onClick={
                            () => {
                                setShowLoadingCharges(true)
                            }
                        }
                        className='block mt-2 bg-blue-600 text-white px-6 py-2 rounded-lg'>Loading Charges</button>
                    <Link href={
                            route('estimate.invoice', {estimate: estimate})
                        }
